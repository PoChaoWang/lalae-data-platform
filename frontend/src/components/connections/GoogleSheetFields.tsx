    ...
    <div className="space-y-8">
      ...
      <div className="bg-gray-800/30 border border-orange-500/20 rounded-2xl p-6">
        ...
        <Alert className="mt-6 bg-blue-500/10 border-blue-500/30 text-blue-400">
            ...
            <AlertDescription>
              <strong>Important:</strong> Grant 'Editor' access to <span className="underline">bot-681@my-project-for-bigquery-445809.iam.gserviceaccount.com</span> and set up the <span className="font-bold">General Access</span> to <span className="underline">Anyone with the link</span> for this sheet.
